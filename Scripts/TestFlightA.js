...
script-providers:
  TestFlight.A:
    url: https://raw.githubusercontent.com/Centralmatrix3/Scripts/master/Scripts/TestFlightA.js
    interval: 86400
----------------------------------------
[Script]
TF账户管理 = type=http-request,pattern=^https:\/\/testflight\.apple\.com\/v\d\/(app|account|invite)s\/,script-path=https://raw.githubusercontent.com/Centralmatrix3/Scripts/master/Scripts/TestFlightA.js,requires-body=true,timeout=120

[MITM]
hostname = %APPEND% testflight.apple.com
----------------------------------------
[rewrite_local]
^https:\/\/testflight\.apple\.com\/v\d\/(app|account|invite)s\/ url script-analyze-echo-response https://raw.githubusercontent.com/Centralmatrix3/Scripts/master/Scripts/TestFlightA.js
