...
script-providers:
  淘宝比价:
    url: https://raw.githubusercontent.com/Centralmatrix3/Scripts/master/Scripts/TB.Price.js
    interval: 86400
----------------------------------------
[Script] 
淘宝比价 = type=http-response,pattern=^http://.+/amdc/mobileDispatch,script-path=https://raw.githubusercontent.com/Centralmatrix3/Scripts/master/Scripts/TB.Price.js,requires-body=true,timeout=120

淘宝比价 = type=http-response,pattern=^https?://trade-acs\.m\.taobao\.com/gw/mtop\.taobao\.detail\.getdetail,script-path=https://raw.githubusercontent.com/Centralmatrix3/Scripts/master/Scripts/TB.Price.js,requires-body=true,timeout=120

[MITM]
hostname = %APPEND% trade-acs.m.taobao.com
----------------------------------------
[rewrite_local]
^http://.+/amdc/mobileDispatch url script-response-body https://raw.githubusercontent.com/Centralmatrix3/Scripts/master/Scripts/TB.Price.js

^https?://trade-acs\.m\.taobao\.com/gw/mtop\.taobao\.detail\.getdetail url script-response-body https://raw.githubusercontent.com/Centralmatrix3/Scripts/master/Scripts/TB.Price.js
